    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'price' => fake()->numberBetween(700, 900),
                'is_featured' => true,
            ],
            [
            ...
            [
                ...
                'price' => fake()->numberBetween(1100, 1300),
                'sale_price' => fake()->numberBetween(800, 1000),
                'is_featured' => true,
            ],
            [
            ...
            [
                ...
                'price' => fake()->numberBetween(1100, 1300),
                'sale_price' => fake()->numberBetween(500, 700),
            ],
            [
            ...
            [
                ...
                'price' => fake()->numberBetween(900, 1300),
                'sale_price' => fake()->numberBetween(200, 700),
            ],
            [
                'name' => 'NYX Beauty Couton Pallete Makeup 12',
                'price' => fake()->numberBetween(900, 1300),
                'sale_price' => fake()->numberBetween(300, 800),
            ],
            [
                'name' => 'NYX Beauty Couton Pallete Makeup 12',
                'price' => fake()->numberBetween(700, 1000),
                'sale_price' => fake()->numberBetween(400, 700),
            ],
            [
                'name' => 'MVMTH Classical Leather Watch In Black',
                'price' => fake()->numberBetween(600, 1000),
                'sale_price' => fake()->numberBetween(200, 500),
            ],
            [
                'name' => 'Baxter Care Hair Kit For Bearded Mens',
                'price' => fake()->numberBetween(400, 700),
                'sale_price' => fake()->numberBetween(100, 300),
            ],
            [
                'name' => 'Ciate Palemore Lipstick Bold Red Color',
                'price' => fake()->numberBetween(500, 1300),
                'sale_price' => fake()->numberBetween(200, 400),
            ],
        ];
        ...
        foreach ($products as $key => $item) {
            ...
            $item['sku'] = 'SW-' . fake()->numberBetween(100, 200);
            ...
            $product->categories()->sync([
                fake()->numberBetween(1, 37),
                fake()->numberBetween(1, 37),
                fake()->numberBetween(1, 37),
                fake()->numberBetween(15, 37),
            ]);
        ...
        foreach ($products as $key => $item) {
            ...
            for ($j = 0; $j < fake()->numberBetween(1, 5); $j++) {
                $variation = Product::query()->create([
                    ...
                    'sale_price' => is_int(
                        $product->id
                    ) && $product->id % 4 == 0 ? ($product->price - $product->price * fake()->numberBetween(
                        10,
                        30
                    ) / 100) : null,
