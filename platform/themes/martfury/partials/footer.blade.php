            ...
            <div class="col-3" style="">
                <div class="row">
                    <div class="col-12" style="margin-bottom:2em;margin-top: -34px;">
                        <img src="https://arabna.shop/storage/logooo-1.png" alt="Descriptive Alt Text"
                            class="img-fluid">
                    </div>
                ...
                <div class="row download-apps" style="text-align-last: center;">
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <a href="#"><img src="{{ Theme::asset()->url('img/Play-store-Button.png') }}" class="img-fluid"
                                alt="Google Play"></a>
                    </div>
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <a href="#"><img src="{{ Theme::asset()->url('img/App-store-Button.png') }}" class="img-fluid"
                                alt="App Store"></a>
                    </div>
                </div>
...
<div class="ps-popup" id="subscribe" data-time="{{ (int)theme_option('newsletter_show_after_seconds', 10) * 1000 }}">
    <div class="ps-popup__content bg--cover"
        ...
        style="background-size: cover!important;"><a class="ps-popup__close" href="#"><i class="icon-cross"></i></a>
        <form method="post" action="{{ route('public.newsletter.subscribe') }}"
            ...
            <div class="ps-form__content">
                ...
                <p>{{ __('Subscribe to the mailing list to receive updates on new arrivals, special offers and our
                    promotions.') }}</p>
