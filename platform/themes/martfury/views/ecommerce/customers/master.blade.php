                        ...
                        <div class="ps-widget__content">
                            <ul>
                                ...
                                @if (EcommerceHelper::isReviewEnabled())
                                    <li @if (Route::currentRouteName() == 'customer.product-reviews') class="active" @endif><a href="{{ route('customer.product-reviews') }}"><i class="icon-star"></i> {{ __('Product reviews') }}</a></li>
                                @endif
